...
const TRUST_STATS = [
  { value: "140+", label: "пунктов проверки", icon: Shield },
  { value: "2 ч", label: "готовность отчёта", icon: Clock },
  { value: "500+", label: "проверенных авто", icon: FileCheck },
  { value: "95%", label: "успешный торг", icon: CheckCircle },
] as const;
          ...
          <div className="grid grid-cols-2 gap-4 sm:gap-6 lg:grid-cols-4">
            {TRUST_STATS.map((stat) => {
              ...
              return (
                <div
                  key={stat.label}
                  className="flex flex-col items-center gap-2 rounded-2xl bg-white/[0.04] px-4 py-5 backdrop-blur-sm border border-white/[0.06] transition-colors hover:bg-white/[0.07]"
                >
                  <Icon
