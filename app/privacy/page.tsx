        ...
        <div className="prose prose-invert max-w-none space-y-8 text-neutral-300">
          ...
          <section>
            ...
            <p>
              ...
              (_ym_uid, _ym_d и др.) загружаются только после вашего согласия в баннере на сайте.
              Без согласия аналитика не подключается и данные не собираются.
            </p>
            <p>
              Вы можете отклонить использование необязательных cookies через кнопку «Отклонить» в баннере.
              Выбор сохраняется в браузере и не показывается повторно до очистки данных сайта.
            </p>
          </section>
